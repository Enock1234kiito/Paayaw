...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--green-dark)' }} className="text-white/75 bg-slate-900">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-5">
              <div
                className="w-12 h-12 rounded-full flex items-center justify-center font-playfair font-black text-xl flex-shrink-0"
            ...
            <div className="flex gap-3 mt-4">
              {['Facebook', 'YouTube', 'Instagram', 'Twitter'].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold transition-colors duration-200 hover:text-green-dark"
        ...
        >
          <span>© {new Date().getFullYear()} Gideon Peprah Ministries. All rights reserved.</span>
